...
public class Product2AppMobile extends Preventivo2AppMobile {
    ...
    public Product2AppMobile(int rateOfDay, int daysMockup, int daysPublishingStores, int daysDbOffline,
