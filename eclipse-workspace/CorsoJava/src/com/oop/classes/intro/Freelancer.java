...
public class Freelancer {
	...
	public static void main(String[] args) {
		...
		System.out.println(freelancer.getUtileTasse());
		System.out.println(freelancer.getTassaInps());
		System.out.println(freelancer.getTassaIrpef());
		System.out.println(freelancer.getRedditoAnnuoNetto());
